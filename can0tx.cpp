...
Can0Tx::Can0Tx(QObject *parent):QObject (parent)
{
...
//FRAME_SEND======================================
void Can0Tx::sendframe(uint CANid, int Byte0, int Byte1, int Byte2, int Byte3, int Byte4, int Byte5, int Byte6, int Byte7)
{
